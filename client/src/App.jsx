...
import CreateCommunity from './src/scenes/community/createCommunity';
...
const App = () => {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path='community/:communityName/createCommunityPost' element={<CreateCommunityPost/>}></Route>
